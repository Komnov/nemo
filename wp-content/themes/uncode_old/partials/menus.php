															...
															<div class="row-menu'.$main_width.'">
																<div class="row-menu-inner'.$stylemainback.'">
																	<div id="logo-container-mobile" class="col-lg-0 logo-container middle">
																		...
																		<div class="mmb-container"><div class="mobile-additional-icons">'.$search_icon_mobile.$login_account_icon_mobile.$woo_wishlist_icon_mobile.$woo_icon_mobile.'</div><div class="mobile-menu-button 1 '.$buttonstyle_primary.' lines-button x2"><span class="lines"></span></div></div>
																	</div>
													...
													'<div class="navbar menu-secondary'.str_replace(' menu-transparent', '', $stylemaincombo).$main_absolute.'">
														<div class="menu-container-mobile '.$effects.$stylemainbackfull.'">
															<div class="row-menu style-'.$stylemain.'-bg">
																...
																<div class="mmb-container"><div class="mobile-additional-icons">'.$search_icon_mobile.$login_account_icon_mobile.$woo_wishlist_icon_mobile.$woo_icon_mobile.'</div><div class="mobile-menu-button 2 '.$buttonstyle_primary.' lines-button x2"><span class="lines"></span></div></div>
															</div>
														</div>
													</div>
															...
															<div class="row-menu'.$main_width.'">
																<div class="row-menu-inner'.$stylemainback.'">
																	<div id="logo-container-mobile" class="col-lg-0 logo-container megamenu-diff desktop-hidden">
																		...
																		<div class="mmb-container"><div class="mobile-additional-icons">'.$search_icon_mobile.$login_account_icon_mobile.$woo_wishlist_icon_mobile.$woo_icon_mobile.'</div><div class="mobile-menu-button 4 '.$buttonstyle_primary.' lines-button x2"><span class="lines"></span></div></div>
																	</div>
																	<div class="col-lg-12 main-menu-container middle">
																		<div class="menu-horizontal' . $sub_shadows . '">
																			<div class="menu-horizontal-inner">';
					...
					$this->html = '<div class="menu-wrapper'.$menu_shrink.$menu_sticky.$menu_no_arrow.'">
						...
						$this->html .=										'</div>
																	...
																	<div id="logo-container-mobile" class="col-lg-2 logo-container middle">
																		...
																		<div class="mmb-container"><div class="mobile-additional-icons">'.$search_icon_mobile.$login_account_icon_mobile.$woo_wishlist_icon_mobile.$woo_icon_mobile.'</div><div class="mobile-menu-button 7 '.$buttonstyle_primary.' lines-button x2"><span class="lines"></span></div></div>
																	</div>
																	<div class="col-lg-5 main-menu-container middle">
																		<div class="menu-horizontal' . $sub_shadows . '">
																			<div class="menu-horizontal-inner">
					...
					if ($menutype !== 'vmenu-offcanvas') {
						$this->html .= 			'<div class="row-inner restrict row-brand">
																	<div id="logo-container-mobile" class="col-lg-12 logo-container">
																		...
																		<div class="mmb-container"><div class="mobile-additional-icons">'.$search_icon_mobile.$login_account_icon_mobile.$woo_wishlist_icon_mobile.$woo_icon_mobile.'</div><div class="mobile-menu-button 8 '.$buttonstyle_primary.' lines-button x2"><span class="lines"></span></div></div>
																	</div>
																</div>';
					}
